                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                      ...
                      <div style={{ position: "relative" }}>
                        ...
                        <div id={"menu-"+entry.id} style={{ display: "none", position: "absolute", right: 0, top: "100%", marginTop: "4px", background: WHITE, borderRadius: "8px", boxShadow: "0 4px 16px rgba(0,0,0,0.12)", border: `1px solid ${BG_DARK}`, minWidth: "130px", zIndex: 100, overflow: "hidden" }}>
                          ...
                          <button onClick={() => handleDelete(entry.id)} style={{ width: "100%", background: "none", border: "none", padding: "10px 14px", textAlign: "left", cursor: "pointer", fontSize: "12px", color: "#000", fontFamily: FONT, display: "flex", alignItems: "center", gap: "8px" }}>
  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
          {shown.map(e => (
            <div key={e.id} style={{ background: GLASS, borderRadius: "10px", border: `1px solid ${ACCENT}`, padding: "16px 18px", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", position: "relative", zIndex: openMenuId === e.id ? 50 : 1 }}>
              <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "8px" }}>
          ...
          <div onClick={e => e.stopPropagation()} style={{ background: BG, borderRadius: "16px", width: "100%", maxWidth: "480px", maxHeight: "90vh", overflowY: "auto", boxShadow: "0 20px 60px rgba(0,0,0,0.2)" }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              <div style={{ position: "absolute", top: "12px", right: "12px", display: "flex", flexDirection: "column", gap: "6px", alignItems: "center" }}>
                <button onClick={() => { setDetail(null); setDetailMenuOpen(false); }} style={{ width: "32px", height: "32px", borderRadius: "50%", background: "rgba(255,255,255,0.82)", border: "none", color: TEXT_DARK, fontSize: "16px", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>✕</button>
                {canEdit && (
                  <div style={{ position: "relative" }}>
        ...
        <div style={{ position: "fixed", bottom: "28px", right: "28px", zIndex: 500, display: "flex", flexDirection: "column", alignItems: "center", gap: "12px" }}>
          ...
          <button onClick={openQuickAdd} title="Mitteilung oder To-Do" style={{ width: "50px", height: "50px", borderRadius: "50%", background: BTN, border: "none", cursor: "pointer", boxShadow: "0 4px 18px rgba(0,0,0,0.20)", display: "flex", alignItems: "center", justifyContent: "center", padding: 0 }}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M11 4H6C4.9 4 4 4.9 4 6V18C4 19.1 4.9 20 6 20H18C19.1 20 20 19.1 20 18V13" stroke="#EBEBE6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M18.5 2.5C19.3 1.7 20.7 1.7 21.5 2.5C22.3 3.3 22.3 4.7 21.5 5.5L12 15L8 16L9 12L18.5 2.5Z" fill="#EBEBE6"/>
            </svg>
          </button>
